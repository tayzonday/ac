...
<header style="border:0px solid red;">
	...
	<div style="background-color:#ddd;height:34px;"></div>
	
	<div style="min-width:900px;height:50px;border-bottom:1px solid #ddd;background-color:#f1f1f1;border:0px solid red;">
		<div style="border:1px solid green;margin:0 auto;min-width:960px;max-width:90%;">
		  Inner
		</div>
	</div>
...
<div id="outer">
	<header>
		<div id="header-left">
			...
			<a id="thread-replies" href="javascript:;" title="' . $my->num_thread_replies . ' thread replies"><span id="thread-replies-num"';
			if($my->num_thread_replies == '0') {
				$o .= ' class="hidden"';
			}
			
			$o .= '>' . $my->num_thread_replies . '</span></a>
			<div id="thread-replies-popup">';
			...
			<a id="post-mentions" href="javascript:;" title="' . $my->num_post_mentions . ' post mentions"><span id="post-mentions-num"';
			if($my->num_thread_replies == '0') {
				$o .= ' class="hidden"';
			}

			$o .= '>' . $my->num_post_mentions . '</span></a>
			<div id="post-mentions-popup">';
